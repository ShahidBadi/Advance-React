      ...
      <aside className="bg-black p-3" style={{ width: '250px', minHeight: '100vh' }}>
        ...
        <ul className="nav nav-pills flex-column mb-auto">
          <li className="nav-item">
            <Link href="/librarian" className="nav-link text-white">
              <i className="bi bi-speedometer2 me-2"></i>Dashboard
            </Link>
          </li>
          <li>
            <Link href="/librarian/books" className="nav-link text-white">
              <i className="bi bi-book-half me-2"></i>Books
            </Link>
          </li>
          <li>
            <Link href="/librarian/members" className="nav-link text-white">
              <i className="bi bi-people me-2"></i>Members
            </Link>
          </li>
          <li>
            <Link href="/librarian/transaction" className="nav-link text-white">
              <i className="bi bi-arrow-left-right me-2"></i>Transactions
            </Link>
          </li>
          <li>
            <Link href="/librarian/reports" className="nav-link text-white">
              <i className="bi bi-bar-chart-line me-2"></i>Reports
            </Link>
          </li>
          <li>
            <Link href="/librarian/profile" className="nav-link text-white">
